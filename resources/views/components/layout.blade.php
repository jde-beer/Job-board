...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="mx-auto mt-10 max-w-2xl bg-gradient-to-r from-indigo-100 from-10% via-sky-100 via-30% to-emerald-100 to-90%  text-slate-700">
        ...
        @if(session('success'))
        <div role="alert"
            class="my-8 rounded-md border-1-4 border-green-300 p-4 text-green-700 opacity-75">
        ...
        @if(session('error'))
        <div role="alert"
            class="my-8 rounded-md border-1-4 border-red-300 p-4 text-red-700 opacity-75">
